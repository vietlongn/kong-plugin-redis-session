package = "kong-plugin-redis-session"  -- TODO: rename, must match the info in the filename of this rockspec!
...
local pluginName = package:match("^kong%-plugin%-(.+)$")  -- "redisSession"
